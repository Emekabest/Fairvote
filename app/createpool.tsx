            ...
            <View className="h-[92%] mt-20" style={{backgroundColor:AppDetails.color.backgroundColor}}>
                <View className="h-[40%] pt-3 px-4" >
                    ...
                    <View className="pt-5">
                        ...
                        <TextInput className="h-15 rounded-full px-5 text-2xl mb-5" placeholderTextColor="gray" value={candidateFirstName} onChangeText={setCandidateFirstName} placeholder="firstname" />

                        <TextInput className="h-15 rounded-full px-5 text-2xl mt-5" placeholderTextColor="gray" value={candidateLastName} onChangeText={setCandidateLastName} placeholder="lastname" />
