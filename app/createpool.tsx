            ...
            <View className="h-[92%] mt-20" style={{backgroundColor:AppDetails.color.backgroundColor}}>
                <View className="h-[40%] pt-3 px-4" >
                    ...
                    <View className="pt-5">
                        ...
                        <TextInput className="h-12 rounded-full px-5 text-lg mb-2" placeholderTextColor="gray" value={candidateFirstName} onChangeText={setCandidateFirstName} placeholder="firstname" />

                        <TextInput className="h-12 rounded-full px-5 text-lg" placeholderTextColor="gray" value={candidateLastName} onChangeText={setCandidateLastName} placeholder="lastname" />

                        <View className="h-28 flex-row">

                            <View className="h-[100%] w-[40%] rounded-lg bg-gray-200 items-center justify-center overflow-hidden">
                                <Image
                ...
                <View className="h-[60%] px-4">
                    <TextInput className="h-[10%] text-lg text-center" placeholderTextColor="gray" value={pollname} onChangeText={setPollName}  placeholder="Enter name of poll" />
